...
public class CategoryListController {
    ...
    @Inject
    public CategoryListController(CategoryService categoryService, ViewManager viewManager) {
    ...
    private void initializeTable() {
        ...
        categoryTable.setOnMouseClicked(event -> {
            if (event.getClickCount() == 2) {
                CategoryListDTO selected = categoryTable.getSelectionModel().getSelectedItem();
                if (selected != null) {
