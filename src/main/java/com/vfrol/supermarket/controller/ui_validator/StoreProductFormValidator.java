...
public class StoreProductFormValidator {
    ...
    public void validateUPCProm(ComboBox<?> box) {
        ValidationHelper.checkRequiredComboBoxConditional(validator, box, isPromotionalObservable, "Base Product is required for promotional products");
    }

    public void validateProduct(ComboBox<?> box) {
        ValidationHelper.checkRequiredComboBoxConditional(validator, box, Bindings.not(isPromotionalObservable), "Product is required for non-promotional store products");
    }
